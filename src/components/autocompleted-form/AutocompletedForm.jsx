  ...
  return (
    <Formik
      initialValues={{
        ...
        phone: "",
        country: "Argentina",
        province: person?.domicilio[0].descripcionProvincia || "",
        locality: person?.domicilio[0].localidad || "",
        street: person?.domicilio[0].calle || "",
        streetNumber: person?.domicilio[0].numero || "",
        floor: person?.domicilio[0].piso || "",
        apartment: person?.domicilio[0].calle || "",
        postalCode: person?.domicilio[0].codigoPostal || "",
        economicActivity: "",
